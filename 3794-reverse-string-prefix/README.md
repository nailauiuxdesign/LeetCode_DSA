<h2><a href="https://leetcode.com/problems/reverse-string-prefix/solutions/?envType=problem-list-v2&envId=string">4177. Reverse String Prefix</a></h2><h3>Easy</h3><hr><p>You are given a string <code>s</code> and an integer <code>k</code>.</p>
